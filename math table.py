...
r1=tkinter.Radiobutton(screen,text="10",variable=choose,value=10)
r2=tkinter.Radiobutton(screen,text="20",variable=choose,value=20)
r3=tkinter.Radiobutton(screen,text="30",variable=choose,value=30)
